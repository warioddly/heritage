    ...
    <main className="relative flex min-h-screen flex-col items-center justify-between px-4 overflow-hidden" >
        ...
        <div>
            ...
            <div className="relative h-screen flex flex-col items-center justify-center mx-auto w-full md:w-1/2">
                ...
                <p className="text-lg text-center mt-4">This is a Heritage project for shows the family tree of the Kyrgyz people.</p>
            </div>
        </div>
        ...
        <div>
            ...
            <div className="relative h-screen flex flex-col items-center justify-center mx-auto w-full md:w-1/2">
                ...
                <p className="text-lg text-center mt-4">So, in our country Kyrgyzstan, ancestors are highly valued, and
                    it
                    is said that everyone should know their line, that is, they should know their seven fathers, and I
