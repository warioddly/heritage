...
export function TreeInteractiveViewer() {
  ...
  const [graphData, setGraphData] = useState({
    nodes: [
      ...
      { data: { id: '6', label: 'Device 4', type: 'ip', source: '8', target: '7',} },
      { data: { id: '7', label: 'Device 5', type: 'ip', target: '9' } },
      { data: { id: '8', label: 'Device 6', type: 'ip' } },
      { data: { id: '9', label: 'Device 7', type: 'ip' } },
    ...
    edges: [
      ...
      // },
      // {
      //   data: { source: '6', target: '8', label: ' 6 -> 9' },
      // },
      // {
