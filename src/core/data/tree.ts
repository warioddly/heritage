import {TreeDefinition} from "@/core/types/tree-definition";


export const treeData: TreeDefinition = {
    nodes: [
        {
            data: {
                id: '1',
